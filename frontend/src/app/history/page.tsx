        ...
        <div className="bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm rounded-2xl shadow-2xl p-8 mb-6">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-semibold tracking-tight mb-2 font-sans" style={{letterSpacing: '-0.02em'}}>
              История <span className="bg-gradient-to-r from-black via-gray-700 to-gray-400 bg-clip-text text-transparent dark:from-white dark:via-gray-300 dark:to-gray-500">анализа</span>
            </h1>
            <p className="text-lg text-muted-foreground font-sans">
              Просмотр предыдущих анализов прочности бетона
            </p>
          </div>
        </div>
      </motion.div>
